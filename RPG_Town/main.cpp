...
int main(int argc, char** argv) {
	...
	*/
    ...
    // ••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••
    // • automatic movement: defining the relevent variables                          •
    // ••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••
	...
	*/
	...
	while (window.isOpen()) {
		...
		if (!pause && !title && window.hasFocus() && sysFader.isComplete())
		{
            ...
            // ••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••
            // • automatic movement: if there is an event, only move through the Event class! •
            // ••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••
            if (event_start) {
		...
		if (layer->name == "Events")
		{
			for (auto object = layer->objects.begin(); object != layer->objects.end(); object++)
			{
				if ((object->GetName() == "Start"))
				{
                    ...
                    else // this is required for player_event to be changed to false!!!
                        player_event = false;
				}
			}
		}
